package e.meghna.informativeapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void navigate(View v){
        ...
        if(choice == 0){
            ...
            webView.loadUrl("file:///android_assert/android.html");}
        else if(choice == 1)
            webView.loadUrl("file:///android_assert/checklist.html");
        else if(choice == 2)
            webView.loadUrl("http://www.coursera.org");
        else if(choice == 3)
            webView.loadUrl("file:///android_assert/supelec.html");
